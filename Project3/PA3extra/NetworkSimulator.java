...
public class NetworkSimulator {
    ...
    public void runSimulator() {
        ...
        while (true) {
            ...
            if (TRACE >= 2) {
                ...
                if (nextEvent.getType() == FROM_LAYER2 ) {
                    ...
                    System.out.printf(" headers: %3d %3d %3d %3d\n",
                            nextEvent.getPacket().header[0], nextEvent.getPacket().header[1],
                            nextEvent.getPacket().header[2], nextEvent.getPacket().header[3]);
                }
            ...
            case LINK_CHANGE:
                if (clocktime < 10001.0) {                    
                	...
                	System.out.println("***********************************");
                	for(int j=0;j<4;j++){
                		System.out.print("n0:"+n0.curcost[j]+"  ");
                	}
                	System.out.println();
                	for(int j=0;j<4;j++){
                		System.out.print("n1:"+n1.curcost[j]+"  ");
                	}
                	System.out.println();
                	for(int j=0;j<4;j++){
                		System.out.print("n2:"+n2.curcost[j]+"  ");
                	}
                	System.out.println();
                	for(int j=0;j<4;j++){
                		System.out.print("n3:"+n3.curcost[j]+"  ");
                	}
                	System.out.println();
                    n0.linkhandler(1, 1);
                    n1.linkhandler(0, 1);
        ...
        System.out.println("***********************************");
        System.out.println("The following matrix is the adjacency matrix of the topology(Not necessarily required!) ");   
    	...
    	System.out.println();
        System.out.println("***********************************");
        System.out.println("The following is the final distance table produced in each node: ");
        n0.printdt();
        n1.printdt();
        n2.printdt();
        n3.printdt();
    ...
    public static void tolayer2(Packet packet) {
        ...
        if (TRACE > 2)  {
            ...
            for (int i = 0; i < 4; i++)
                System.out.printf("%d  ", mypktcopy.header[i]);
            System.out.printf("\n");
        }
