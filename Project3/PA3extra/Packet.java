...
public class Packet {
     ...
     */
    public Packet(int sourceid, int destid, int[] mincost,int[] header) {
    ...
    public Packet(Packet p) {
        if (p == null) {
            ...
            this.header=new int[4];//heheda
            this.header[0]=p.header[0];
            this.header[1]=p.header[1];
            this.header[2]=p.header[2];
            this.header[3]=p.header[3];
        }
    }
}
